  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Front */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#1a1a2e] to-[#16213e] rounded-2xl border border-[#4ecdc4]/50 p-6 backface-hidden">
          ...
          {/* Back */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#2d1b4e] to-[#1a1a2e] rounded-2xl border border-[#ffe66d]/50 p-6 backface-hidden rotate-y-180">
